...
SUSPICIOUS_HOSTS = {
    ...
    "54.94.195.96", "54.94.200.247"a#!/usr/bin/env python3
# Copyright (c) 2013-2017 The Bitcoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
#
...
PATTERN_AGENT = re.compile(r"^(/SubiCore:2.2.(0|1|99)/)$")
    ...
    if m is None:
        ...
        if m is None:
            ...
            if m.group(1) in ['::']: # Not interested in localhost
                return None
            ipstr = m.group(1)
            sortkey = ipstr # SUBI parse IPv6 into number, could use name_to_ipv6 from generate-seeds
            port = int(m.group(2))
    else:
